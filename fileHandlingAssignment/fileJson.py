...
'''NOTE: On using "r+" in above function, using dump() willnot overwrite the existing data.
Inorder to do that, need to use move the cursor to the position 0 using "seek(0)". 
then dump() the data and delete the old data using file.truncate() '''
